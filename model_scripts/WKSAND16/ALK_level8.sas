...
if PP_ar_tx in ('1B','12C','2B','3','3AS','3AN') then NS='N';
...
by geartype aar halfyear NS  scm;
run;
...
by geartype aar halfyear NS   age;
run;
...
by age  geartype aar halfyear NS   maxscm minscm;
run;
...
by age geartype aar halfyear NS;
run;
...
data out.alk_level8;
set aglg13c;* aglg13d;
if maxp gt minp and minp gt 0.00001 then delete;
...
pi=n/s;
level=8;
keep age geartype aar halfyear NS maxp minp prange 
...
proc sort data=out.alk_level8 out=t1;
by  age geartype aar month2 scm;
run;

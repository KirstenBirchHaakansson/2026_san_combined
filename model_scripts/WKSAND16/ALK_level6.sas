...
by geartype aar month2 dobar scm;
run;
...
by geartype aar month2 dobar age;
run;
...
by age  geartype aar month2 dobar maxscm minscm;
run;
...
by age geartype aar month2 dobar;
run;
...
pi=n/s;
level=1;
keep age geartype aar month2 dobar maxp minp prange 
...
proc sort data=out.alk_level6 out=t1;
by  age geartype aar dobar month2 scm;
run;
...
by age geartype aar dobar month2;

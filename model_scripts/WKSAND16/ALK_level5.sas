...
by geartype aar month dobar scm;
run;
...
by geartype aar month dobar age;
run;
...
by age  geartype aar month dobar maxscm minscm;
run;
...
by age geartype aar month dobar;
run;
...
pi=n/s;
level=5;
keep age geartype aar month dobar maxp minp prange 
...
by  age geartype aar dobar month scm;
run;
...
by age geartype aar dobar month;
